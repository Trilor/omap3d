...
export const SIDEBAR_DEFAULT_WIDTH  = 282;  // サイドバーの offsetWidth フォールバック値（px）= 52(アイコンバー) + 230(--panel-w)
...
// ---- カラーリリーフパレット定義（protocols.js / app.js / contours.js 共用） ----
// stops: { t: 0〜1, r, g, b } の配列。t=0 が最低値、t=1 が最高値に対応する色。
export const RELIEF_PALETTES = [
  {
    id: 'rainbow',
    label: '虹色',
    stops: [
  ...
  },
  {
    ...
    label: 'スペクトル',
    stops: [
      { t: 0.00, r:  26, g: 150, b:  65 },
      { t: 0.17, r: 166, g: 217, b: 106 },
      { t: 0.33, r: 217, g: 239, b: 139 },
      { t: 0.50, r: 255, g: 255, b: 191 },
      { t: 0.67, r: 253, g: 174, b:  97 },
      { t: 0.83, r: 244, g: 109, b:  67 },
      { t: 1.00, r: 215, g:  48, b:  39 },
    ],
  },
  {
    id: 'gray',
    ...
    stops: [
      ...
      { t: 0.25, r: 204, g: 204, b: 204 },
      { t: 0.50, r: 102, g: 102, b: 102 },
      { t: 1.00, r:   0, g:   0, b:   0 },
    ],
  },
];
